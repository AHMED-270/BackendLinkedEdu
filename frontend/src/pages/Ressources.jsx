...
const CLASSES_PAR_NIVEAU = {
  maternelle: [
    { value: 'ms-a', label: 'MS A' },
    { value: 'ms-b', label: 'MS B' },
    { value: 'gs-a', label: 'GS A' },
  ],
  primaire: [
    { value: '1ap-a', label: '1AP A' },
    { value: '2ap-a', label: '2AP A' },
    { value: '3ap-a', label: '3AP A' },
    { value: '6ap-b', label: '6AP B' },
  ],
  college: [
    { value: '1ac-a', label: '1AC A' },
    { value: '2ac-a', label: '2AC A' },
    { value: '3ac-b', label: '3AC B' },
  ],
  lycee: [
    { value: 'tc-sci-a', label: 'TC Scientifique A' },
    { value: '1bac-svta', label: '1BAC SVT A' },
    { value: '2bac-svta', label: '2BAC SVT A' },
    { value: '2bac-pca', label: '2BAC PC A' },
  ],
};
...
export default function Ressources() {
  ...
  const handleSubmit = (e) => {
    ...
    setTimeout(() => {
      ...
      setTitle(''); setType(''); setMatiere(''); setNiveau(''); setClasse(''); setFiles([]);
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div className="form-group">
                  ...
                  <select
                    ...
                    required
                  >
                    <option value="">{niveau ? 'Sélectionner' : 'Choisir d abord un niveau'}</option>
